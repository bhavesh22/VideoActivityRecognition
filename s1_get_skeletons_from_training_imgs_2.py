...
if True:  # Include project path
    ...
    # '/home/bhavesh/CAT_BackUp/CAT_AI/thunderpod/RealTime2/Realtime-Action-Recognition/src/../'
...
if True:
    ...
    # '/home/bhavesh/CAT_BackUp/CAT_AI/thunderpod/RealTime2/Realtime-Action-Recognition/src/../data/source_images3/valid_images.txt'
    SRC_IMAGES_FOLDER = par(cfg["input"]["images_folder"])
    # '/home/bhavesh/CAT_BackUp/CAT_AI/thunderpod/RealTime2/Realtime-Action-Recognition/src/../data/source_images3/'
# Output
if True:
    ...
    # '/home/bhavesh/CAT_BackUp/CAT_AI/thunderpod/RealTime2/Realtime-Action-Recognition/src/../data_proc/raw_skeletons/images_info.txt'
    # Each txt will store the skeleton of each image
    DST_DETECTED_SKELETONS_FOLDER = par(
        cfg["output"]["detected_skeletons_folder"])
    # '/home/bhavesh/CAT_BackUp/CAT_AI/thunderpod/RealTime2/Realtime-Action-Recognition/src/../data_proc/raw_skeletons/skeleton_res/'

    # Each image is drawn with the detected skeleton
    DST_VIZ_IMGS_FOLDER = par(cfg["output"]["viz_imgs_folders"])
    # '/home/bhavesh/CAT_BackUp/CAT_AI/thunderpod/RealTime2/Realtime-Action-Recognition/src/../data_proc/raw_skeletons/image_viz/'
# Openpose
if True:
...
if __name__ == "__main__":
    ...
    # '/home/bhavesh/CAT_BackUp/CAT_AI/thunderpod/RealTime2/Realtime-Action-Recognition/src/../data_proc/raw_skeletons'
    ...
    for ith_img in range(num_total_images):
        # print("Processing starts " + ith_img)
